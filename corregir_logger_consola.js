...
async function corregirLogger() {
  try {
    console.log('🔄 Corrigiendo configuración del logger...');
...
module.exports = logger;`;
    ...
    console.log('✅ Logger corregido correctamente');
    console.log('\n🚀 Para aplicar los cambios:');
    console.log('1. Detén el bot actual (Ctrl+C)');
    console.log('2. Reinicia el bot con: npm start');
    console.log('3. Observa los nuevos logs - ya no deberías ver [object Object]');
